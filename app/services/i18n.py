TRANSLATIONS = {
    "en": {
        ...
        "tournament_promote_rule": "Promotion depends on stage: Stage I — Top-3, Stage II/III — Top-4.",
    ...
    "ru": {
        ...
        "tournament_promote_rule": "Продвижение по стадиям: I этап — топ-3, II/III этап — топ-4.",
