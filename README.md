...
| 2) Полный цикл стадий playoff (56→32→16→8) + ручные override | ✅ Реализовано | Генератор стадий переведен на 4 этапа: stage_1_8, stage_1_4, stage_semifinal_groups, stage_final; финал работает по special final rule. |
...
- **Итерация 4:** стадии playoff (stage_1_8, stage_1_4, stage_semifinal_groups, stage_final), продвижение участников.
