...
| 2) Полный цикл плей-офф (1/16, 1/8, 1/4, semifinal, final) + ручные override | ✅ Реализовано | Перестроен генератор стадий на фиксированный цикл 32→16→8→4→2, добавлен manual winner override для матчей. |
